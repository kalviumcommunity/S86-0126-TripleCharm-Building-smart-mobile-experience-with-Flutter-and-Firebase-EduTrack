...
// to automatically test authentication flows with REAL Firebase.
//
// RUN COMMANDS:
// flutter test integration_test/auth_flow_test.dart
// OR with a device/emulator:
...
void main() {
  ...
  group('Authentication Flow Tests', () {
    ...
    group('Signup Tests', () {
      ...
      testWidgets('1. Teacher Signup - Success', (tester) async {
      ...
      testWidgets('2. Student Signup - Success', (tester) async {
        // Clean up existing
        try {
          final existingUser = await FirebaseAuth.instance
              .signInWithEmailAndPassword(
      ...
      testWidgets('3. Signup with Duplicate Email - Should Fail', (tester) async {
      ...
      testWidgets('4. Signup with Weak Password - Should Fail', (tester) async {
        expect(
          () => AuthService.signUp(
            name: testName,
      ...
      testWidgets('5. Signup with Invalid Email - Should Fail', (tester) async {
        expect(
          () => AuthService.signUp(
            name: testName,
      ...
      testWidgets('6. Signup with Empty Name - Should Fail', (tester) async {
        expect(
          () => AuthService.signUp(
            name: '', // Empty name
    ...
    group('Login Tests', () {
      ...
      testWidgets('7. Teacher Login - Success', (tester) async {
      ...
      testWidgets('8. Student Login - Success', (tester) async {
        final userId = await AuthService.login(
          email: testStudentEmail,
          password: testPassword,
        );
      ...
      testWidgets('9. Login with Wrong Password - Should Fail', (tester) async {
        expect(
          () => AuthService.login(
            email: testTeacherEmail,
      ...
      testWidgets('10. Login with Non-existent Email - Should Fail', (tester) async {
        expect(
          () => AuthService.login(
      ...
      testWidgets('11. Login with Empty Email - Should Fail', (tester) async {
        expect(
          () => AuthService.login(
            email: '',
            password: testPassword,
      ...
      testWidgets('12. Login Updates Last Login Time', (tester) async {
        final userId = await AuthService.login(
          email: testTeacherEmail,
          password: testPassword,
        );
    ...
    group('Role-Based Access Control Tests', () {
      ...
      testWidgets('13. Verify Teacher Role from Firestore', (tester) async {
      ...
      testWidgets('14. Verify Student Role from Firestore', (tester) async {
        await AuthService.login(
          email: testStudentEmail,
          password: testPassword,
        );
      ...
      testWidgets('15. Role Case Insensitivity', (tester) async {
    ...
    group('Logout Tests', () {
      ...
      testWidgets('16. Logout Clears Authentication', (tester) async {
        await AuthService.login(
          email: testTeacherEmail,
          password: testPassword,
        );
      ...
      testWidgets('17. Multiple Logout Calls - No Error', (tester) async {
        await AuthService.login(
          email: testTeacherEmail,
          password: testPassword,
        );
    ...
    group('Data Integrity Tests', () {
      ...
      testWidgets('18. User Document Matches Auth User', (tester) async {
        final userId = await AuthService.login(
          email: testTeacherEmail,
          password: testPassword,
        );
      ...
      testWidgets('19. User Data Persists After Login/Logout Cycle', (tester) async {
        // Login
        final userId = await AuthService.login(
          email: testTeacherEmail,
          password: testPassword,
      ...
      testWidgets('20. Phone Number is Optional', (tester) async {
    ...
    group('Error Handling Tests', () {
      ...
      testWidgets('21. Auth State Changes Properly', (tester) async {
  ...
  tearDownAll(() async {
    ...
    try {
      ...
      await FirebaseAuth.instance.currentUser?.delete();
      print('✅ Teacher test user deleted');
    } catch (e) {
      print('ℹ️  Teacher test user not found or already deleted');
    }
    ...
    try {
      ...
      await FirebaseAuth.instance.currentUser?.delete();
      print('✅ Student test user deleted');
    } catch (e) {
      print('ℹ️  Student test user not found or already deleted');
    }
